...
static GLfloat unit_cube[] = {
		 ...
		 0.0f,  0.0f,  1.0f, -0.5f,  0.5f,  0.5f,
		 0.0f,  0.0f,  1.0f, -0.5f, -0.5f,  0.5f,
		 0.0f,  0.0f,  1.0f,  0.5f, -0.5f,  0.5f,  // v0,v1,v2,v3 (front)
		 1.0f,  0.0f,  0.0f,  0.5f,  0.5f,  0.5f,
		 1.0f,  0.0f,  0.0f,  0.5f, -0.5f,  0.5f,
		 1.0f,  0.0f,  0.0f,  0.5f, -0.5f, -0.5f,
		 1.0f,  0.0f,  0.0f,  0.5f,  0.5f, -0.5f,  // v0,v3,v4,v5 (right)
		 0.0f,  1.0f,  0.0f,  0.5f,  0.5f,  0.5f,
		 0.0f,  1.0f,  0.0f,  0.5f,  0.5f, -0.5f,
		 0.0f,  1.0f,  0.0f, -0.5f,  0.5f, -0.5f,
		 0.0f,  1.0f,  0.0f, -0.5f,  0.5f,  0.5f,  // v0,v5,v6,v1 (top)
		-1.0f,  0.0f,  0.0f, -0.5f,  0.5f,  0.5f,
		-1.0f,  0.0f,  0.0f, -0.5f,  0.5f, -0.5f,
		-1.0f,  0.0f,  0.0f, -0.5f, -0.5f, -0.5f,
		-1.0f,  0.0f,  0.0f, -0.5f, -0.5f,  0.5f,  // v1,v6,v7,v2 (left)
		 0.0f, -1.0f,  0.0f, -0.5f, -0.5f, -0.5f,
		 0.0f, -1.0f,  0.0f,  0.5f, -0.5f, -0.5f,
		 0.0f, -1.0f,  0.0f,  0.5f, -0.5f,  0.5f,
		 0.0f, -1.0f,  0.0f, -0.5f, -0.5f,  0.5f,  // v7,v4,v3,v2 (bottom)
		 0.0f,  0.0f, -1.0f,  0.5f, -0.5f, -0.5f,
		 0.0f,  0.0f, -1.0f, -0.5f, -0.5f, -0.5f,
		 0.0f,  0.0f, -1.0f, -0.5f,  0.5f, -0.5f,
		 0.0f,  0.0f, -1.0f,  0.5f,  0.5f, -0.5f   // v4,v7,v6,v5 (back)
};
